    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="flex space-x-4">
              <Link href="https://github.com/akshar1322">
                <Image src={GithubIcon} alt="Github Icon" className="w-6 h-6" />
              </Link>
              <Link href="https://www.linkedin.com/in/akshar-patel-4a78b0217/">
                <Image src={LinkedinIcon} alt="Linkedin Icon" className="w-6 h-6" />
              </Link>
              <Link href="https://www.instagram.com/_akshar.x/">
                <Image src={InstagramIcon} alt="Instagram Icon" className="w-6 h-6" />
              </Link>
